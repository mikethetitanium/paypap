...
public class Statutory {
    ...
    @ManyToOne
    @JoinColumn(name = "staff_id", referencedColumnName = "id")  // Foreign key
    ...
    @Column(name = "considered_pension_contribution")
    private double consideredPensionContribution;

    @Column(name = "considered_mortgage_interest")
    private double consideredMortgageInterest;
}
